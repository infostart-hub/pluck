...
Сценарий: Имя объекта расширения
    Когда Я добавляю параметры для команды "oscript"
    | src/pluck.os |
    | p |
    | fixtures/Расширение1.cfe |
    И Я выполняю команду "oscript"
    Тогда я вижу в консоли строку подобно "Расширение1"

Сценарий: Имя объекта расширения, имя файла и имя метаданного не совпадают
    Когда Я добавляю параметры для команды "oscript"
    | src/pluck.os |
    | p |
    | fixtures/Расширение1_ДругоеИмяФайла.cfe |
    И Я выполняю команду "oscript"
    Тогда я вижу в консоли строку подобно "Расширение1"
